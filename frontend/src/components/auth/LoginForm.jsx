  ...
  return (
    <div className="w-full bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
      ...
      <div className="flex bg-gray-100 p-1 rounded-xl mb-6">
        <button className="flex-1 py-2 text-sm font-semibold text-emerald-700 bg-white rounded-lg shadow-sm flex items-center justify-center gap-1">
          <span>➔</span> Đăng nhập
        </button>
        <button className="flex-1 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 flex items-center justify-center gap-1">
          <span>👤+</span> Đăng ký
        </button>
      </div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-emerald-800 hover:bg-emerald-900 text-white font-semibold py-3 rounded-xl transition flex items-center justify-center gap-2 text-sm shadow-md"
        >
      ...
      <div className="relative my-6 text-center">
        ...
        <span className="relative bg-white px-3 text-[11px] font-semibold text-gray-400 tracking-wider">
          HOẶC TIẾP TỤC BẰNG
        </span>
      </div>

      <div className="grid grid-cols-2 gap-3">
        <button className="flex items-center justify-center gap-2 border border-gray-200 py-2 rounded-xl hover:bg-gray-50 text-xs font-semibold text-gray-700">
      ...
      <p className="text-[10px] text-gray-400 text-center mt-4 leading-relaxed">
        ...
        <a href="#" className="underline">Chính sách bảo mật</a> của K-Tutor.
      </p>
    </div>
  );
}